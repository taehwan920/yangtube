...
export default {
    ...
    nextUrl: VideoSummary[1].pageUrl,
    videoUrl: VideoSummary[0].videoUrl,
    thumbnailUrl: VideoSummary[0].thumbnailUrl,
    nextThumb: VideoSummary[0].nextThumb,
    ...
    comments: [
        {
            name: '이영종',
            iconColor: '#00579C',
            timestamp: 1596032376962,
            content: `아니 지금 시국이 이런데 언제 놀러가라는 거죳?!?!!!!`,
            likes: 15,
            replies: [
                {
                    name: '박규혁',
                    iconColor: '#C1390A',
                    timestamp: 1596032567097,
                    content: `시국 끝나고 가면 되지`,
                    likes: 0
                },
                {
                    name: '이동규',
